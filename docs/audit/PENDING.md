...
| When | Item | Why then |
|---|---|---|
| Next | Part 08 as normal (Part 07 done 26 Sep and hands Part 08 several items: see `findings/07-mobile-foundation.md` › Deferred. Part 12 still audits the presigned upload path; see `findings/PV-providers.md`) | |
