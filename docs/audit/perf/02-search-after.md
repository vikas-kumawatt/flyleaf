# Bench: 02-search-after

2026-09-25T04:44:41.146Z · commit `1e1bf50` (working tree dirty) · http://localhost:3000 · Node v22.20.0
...
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| search:prefix ⚠ p50/p95/p99 | guest | 298 | 1018 | 1091 | 1105 | 22.1 | 224 | 0 | 2.4 | 271 | 1 (0–1) | 200×15 |
| search:common ⚠ saturated/p50/p95/p99 | guest | 10000 | 10000 | 10000 | 10000 | 0 | 0 | ** timeouts×10 unfinished×10** | 126.4 | 26246 | 1 (1–1) | 200×2 timeout×1 |
| search:author ⚠ p50/p95/p99 | guest | 441 | 840 | 1262 | 1323 | 19.6 | 198 | 0 | 2.2 | 461 | 1 (1–2) | 200×15 |
| search:cjk ⚠ saturated/p50/p95/p99 | guest | 1195 | 10000 | 10000 | 10000 | 1 | 10 | ** timeouts×5 unfinished×10** | 183.8 | 30000 | — | timeout×1 |
| search:typo ⚠ saturated/p50/p95/p99 | guest | 2842 | 10000 | 10000 | 10000 | 0.3 | 6 | ** timeouts×3 unfinished×10** | 94.9 | 1608 | 1 (1–1) | 200×2 timeout×2 |
| search:isbn ⚠ p50 | guest | 159 | 219 | 469 | 814 | 68.8 | 694 | 0 | 2.1 | 106 | 2 (2–2) | 200×15 |
