...
- Follow and pending request API routes (`POST /v1/users/:id/follow`, `DELETE /v1/users/:id/follow`, `GET /v1/me/follow-requests`, `POST /v1/me/follow-requests/:requesterId/accept`, `POST /v1/me/follow-requests/:requesterId/reject`) synchronized with 0 OpenAPI contract drift.
...
- Mobile screens: `UserProfileScreen` (`apps/mobile/app/user/[id].tsx`) with haptic follow toggle, mutual follow indicator ("Follows you"), and restricted private view; `FollowRequestsScreen` (`apps/mobile/app/profile/requests.tsx`) for managing incoming follow requests with 1-tap accept/decline.
