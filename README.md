...
**Import & Export (IM-01 through IM-07):**
...
| `vitest run` (API) | **568 tests** across **26 test suites** — identity (47), schema (29), search (33), ingest (65), outbound (27), jobs (10), relevance (10), dedupe (38), ISBN (18), authorization (43), contract (8), hooks (17), admin (22), admin-catalog (7), reading (10), reviews (12), profile-stats (8), telemetry (7), shelves-migration (11), shelves (36), shelves-privacy (20), imports-migration (12), imports (16), import-mapping (37), import-matcher (12), import-committer (14). Every suite that touches SQL runs against **PGlite** (Postgres compiled to WASM) |
